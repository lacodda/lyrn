...
pub fn sources() -> Vec<SourceFile> {
    vec![
        SourceFile {
            path: "Cargo.toml",
            contents: Contents::Text(include_str!("cli/Cargo.toml.tmpl")),
            executable: false,
            addon: None,
        },
        SourceFile {
            path: "build.rs",
            contents: Contents::Text(include_str!("cli/build.rs.tmpl")),
            executable: false,
            addon: None,
        },
        SourceFile {
            path: "rustfmt.toml",
            contents: Contents::Text(include_str!("cli/rustfmt.toml.tmpl")),
            executable: false,
            addon: None,
        },
        SourceFile {
            path: "src/main.rs",
            contents: Contents::Text(include_str!("cli/src/main.rs.tmpl")),
            executable: false,
            addon: None,
        },
        SourceFile {
        ...
        SourceFile {
            ...
            contents: Contents::Text(include_str!("cli/src/hello.rs.tmpl")),
            executable: false,
            addon: None,
        },
        SourceFile {
        ...
        SourceFile {
            path: "tests/cli.rs",
            contents: Contents::Text(include_str!("cli/tests/cli.rs.tmpl")),
            executable: false,
            addon: None,
        },
        SourceFile {
        ...
        SourceFile {
            path: "LICENSE",
            contents: Contents::Text(include_str!("cli/LICENSE.tmpl")),
            executable: false,
            addon: None,
        },
        SourceFile {
            path: "CHANGELOG.md",
            contents: Contents::Text(include_str!("cli/CHANGELOG.md.tmpl")),
            executable: false,
            addon: None,
        },
        SourceFile {
            path: "cliff.toml",
            contents: Contents::Text(include_str!("cli/cliff.toml.tmpl")),
            executable: false,
            addon: None,
        },
        SourceFile {
        ...
        SourceFile {
            path: ".editorconfig",
            contents: Contents::Text(include_str!("cli/editorconfig.tmpl")),
            executable: false,
            addon: None,
        },
        SourceFile {
            path: ".gitattributes",
            contents: Contents::Text(include_str!("cli/gitattributes.tmpl")),
            executable: false,
            addon: None,
        },
        SourceFile {
            path: ".github/workflows/ci.yml",
            contents: Contents::Text(include_str!("cli/github/ci.yml.tmpl")),
            executable: false,
            addon: None,
        },
        SourceFile {
            path: ".github/workflows/release.yml",
            contents: Contents::Text(include_str!("cli/github/release.yml.tmpl")),
            executable: false,
            addon: None,
        },
        SourceFile {
            path: ".github/workflows/publish.yml",
            contents: Contents::Text(include_str!("cli/github/publish.yml.tmpl")),
            executable: false,
            addon: None,
        },
        SourceFile {
            path: "tools/install.sh",
            contents: Contents::Text(include_str!("cli/tools/install.sh.tmpl")),
            executable: true,
            addon: None,
        },
        SourceFile {
            path: "tools/install.ps1",
            contents: Contents::Text(include_str!("cli/tools/install.ps1.tmpl")),
            executable: false,
            addon: None,
        },
        SourceFile {
            path: "npm/package.json",
            contents: Contents::Text(include_str!("cli/npm/package.json.tmpl")),
            executable: false,
            addon: None,
        },
        SourceFile {
            path: "npm/download.js",
            contents: Contents::Text(include_str!("cli/npm/download.js.tmpl")),
            executable: false,
            addon: None,
        },
        SourceFile {
            path: "npm/install.js",
            contents: Contents::Text(include_str!("cli/npm/install.js.tmpl")),
            executable: false,
            addon: None,
        },
        SourceFile {
            path: "npm/run.js",
            contents: Contents::Text(include_str!("cli/npm/run.js.tmpl")),
            executable: true,
            addon: None,
        },
        SourceFile {
        ...
        SourceFile {
            path: "lyrn.toml",
            contents: Contents::Text(include_str!("cli/lyrn.toml.tmpl")),
            executable: false,
            addon: None,
        },
    ]
